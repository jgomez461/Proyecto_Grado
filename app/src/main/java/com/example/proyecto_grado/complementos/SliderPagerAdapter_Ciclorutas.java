...
public class SliderPagerAdapter_Ciclorutas extends FragmentStatePagerAdapter {

    private List<Fragment> fragmentList;

    public SliderPagerAdapter_Ciclorutas(FragmentManager fm, List<Fragment> fragmentList){
        super(fm);
